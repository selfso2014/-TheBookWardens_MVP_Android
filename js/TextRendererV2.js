        ...
        setTimeout(() => {
            ...
            (() => {
                ...
                if (!document.getElementById('replay-blink-style')) {
                    ...
                    st.textContent = `@keyframes replayBlink{
                        0%,100%{opacity:1} 45%{opacity:1} 55%{opacity:0.15} }` ;
                    document.head.appendChild(st);
                }

                // Dot (green plasma sphere)
                const dot = document.createElement('span');
                dot.textContent = '●';
                Object.assign(dot.style, {
                    color: '#00ff88',
                    fontSize: 'clamp(12px, 3vw, 16px)',
                    textShadow: '0 0 10px rgba(0,255,136,0.9), 0 0 22px rgba(0,255,136,0.5)',
                    marginRight: '7px',
                ...
                Object.assign(txt.style, {
                    ...
                    letterSpacing: '3px',
                    color: '#ffffff',
                    textShadow: '0 0 12px rgba(200,140,255,0.8)',
                    verticalAlign: 'middle',
                });
                ...
                Object.assign(label.style, {
                    ...
                    pointerEvents: 'none',
                    zIndex: '9999999',
                    animation: 'replayBlink 1.6s ease-in-out infinite',
                });
